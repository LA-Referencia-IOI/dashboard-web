                ...
                <div class="box box-solid box-body box-profile">
                    @if (Auth::user()->getProfilePicture())
                        <img class="profile-user-img img-responsive img-circle"
                            src="{{ asset('storage/' . Auth::user()->getProfilePicture()) }}"
                            alt="{{ Auth::user()->name }}" title="{{ Auth::user()->name }}">
                    @else
                        <img class="profile-user-img img-responsive img-circle"
                            src="{{ asset('vendor/images/user-default.png') }}" alt="{{ Auth::user()->name }}"
                        ...
                        <div class="custom-file">
                            ...
                            <div class="{{ Auth::user()->getIdFromProfilePicture() ? 'col-md-9' : 'col-md-12' }}">
                                <label class="btn btn-primary btn-block" for="fileUser" data-toggle="tooltip"
                                    data-placement="left" title="Resolução ideal: 800x800">Escolher imagem do perfil</label>
                            </div>
                            <div class="col-md-3">
