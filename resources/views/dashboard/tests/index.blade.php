        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    Swal.fire('Success', 'E2E Tests passed successfully!', 'success');
                } else {
                    logOutput.removeClass('text-success').addClass('text-danger');
                    Swal.fire('Failed', 'E2E Tests failed. Check logs for details.', 'error');
                }
            ...
            error: function(xhr, status, error) {
                ...
                Swal.fire('Error', 'An unexpected error occurred during execution.', 'error');
                btn.prop('disabled', false);
            }
        });
    });
